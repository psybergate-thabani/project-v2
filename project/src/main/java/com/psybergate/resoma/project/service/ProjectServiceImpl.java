...
import com.psybergate.resoma.project.resource.PeopleServiceResource;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    private PeopleServiceResource peopleServiceResource;

    public ProjectServiceImpl(ProjectRepository projectRepository,
                              PeopleServiceResource peopleServiceResource) {
        this.projectRepository = projectRepository;
        this.peopleServiceResource = peopleServiceResource;
    }
    ...
    public Allocation allocateEmployee(UUID projectId, @Valid Allocation allocation) {
        Project project = projectRepository.getOne(projectId);
        if (!peopleServiceResource.exist(allocation.getEmployeeId()).getExist())
            throw new ValidationException("The employeeId \"" + allocation.getEmployeeId() + "\"");
