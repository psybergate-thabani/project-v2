...
class ProjectServiceTest {
    ...
    @BeforeEach
    void setUp() {
        projectService = new ProjectServiceImpl(projectRepository, peopleServiceResource);
    ...
    void shouldAllocateEmployeeToProject_whenEmployeeIsAllocatedToProject() {
        ...
        when(projectRepository.getOne(project.getId())).thenReturn(project);
        when(projectRepository.save(project)).thenReturn(project);
        when(peopleServiceResource.exist(allocation.getEmployeeId())).thenReturn(new ValidationDTO(true));
